...
const Header = () => {
  ...
  return (
    <div className="Header">
      {/* Header TopBar */}
      <div
        className="Header__topbar space__beetween"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Chào mừng đến cửa hàng... Hãy mua sản phẩm để bản thân ngày càng
              được xinh đẹp
            </span>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            kiet.ch.61cntt@ntu.edu.vn
          </span>
        </div>
      </div>
      {/* Header Navbar */}
      <div
        className="navbar flex pz__10 space__beetween"
        ref={switcherTab}
        style={{ backgroundColor: "white" }}
      >
        <div
